    ...
    <div className="flex flex-col gap-10 pb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <p className="text-lg font-medium leading-relaxed text-gray-800">
              {summary.split('. ').map((sentence, i) => (
                <span
                  key={i}
                  className={
                    sentence.includes('12% lower') || sentence.includes('resulting in $45 monthly savings')
        ...
        <div className="flex flex-col gap-12">
          ...
          <button className="flex items-center justify-center gap-3 py-4 border border-black rounded-2xl font-bold hover:bg-black hover:text-white transition-all group">
            <Share2 size={20} />
            Share Summary
          </button>
        </div>
