...
export function TransactionForm({ onSubmit, onCancel, isSubmitting = false }: TransactionFormProps) {
  ...
  return (
    <View className="gap-8">
      ...
      <Input label="Category" value={categoryName} onChangeText={setCategoryName} placeholder="Food" />
      ...
      <View className="flex-row gap-3 pt-4">
        ...
        <View className="flex-1">
          <Button label={isSaving || isSubmitting ? 'Saving...' : 'Save'} onPress={submit} disabled={isSaving || isSubmitting} />
        </View>
      </View>
    </View>
  );
