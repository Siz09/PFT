...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    success: 'bg-accent hover:bg-green-600 text-white focus:ring-accent',
    danger: 'bg-warning hover:bg-red-600 text-white focus:ring-warning',
    outline:
      'border border-gray-300 dark:border-gray-600 bg-transparent hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 focus:ring-gray-500'
  };
  ...
  return (
    <motion.button
      ...
      className={`${baseClasses} ${variants[variant ?? 'primary']} ${sizes[size ?? 'md']} ${disabledClasses} ${className}`}
